...
import { getCacheStats, clearCache } from '@/api/yahooFinance'
import type { CacheStats } from '@/types'

export function BuildSettings() {
  const { theme, toggleTheme, displayCurrency, setDisplayCurrency } = useUIStore()
      ...
      <Card>
        <CardContent className="py-4">
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="text-muted-foreground">v0.1.0 — Phase 1</span>
          </div>
        </CardContent>
      </Card>
    </div>
